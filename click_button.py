...
mobile_user_agent = "Mozilla/5.0 (Linux; Android 10; XQ-AS72) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/86.0.4240.198 Mobile Safari/537.36"
...
try:
    ...
    driver.add_cookie({'name': 'PHPSESSID', 'value': '84b995decb531dc7e6a69dd81cb7e331'})
    time.sleep(2)
    # to refresh the page
    driver.refresh()
